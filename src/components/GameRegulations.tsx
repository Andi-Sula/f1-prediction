...
export default function GameRegulations() {
        ...
        >
          ...
          >
            <div className="flex items-center justify-between p-4 border-b border-[var(--color-border)]">
              <h2 className="text-sm font-bold text-[var(--color-text)]">Game Regulations & Mechanics</h2>
              <button
                onClick={() => setOpen(false)}
            ...
            <iframe
              src="/game-regulations.pdf"
              className="flex-1 w-full"
              title="Game Regulations & Mechanics"
            />
          </div>
        </div>
      )}
